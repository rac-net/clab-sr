###  RampUp to Automation part2 - Ansible ###

This is a repository containing all the files used to create the segment-routing network using ansible.

it includes the Containerlab script, plus the ansible playbooks for both Nokia and Cisco.

The playbook creates a segment-routing network from scratch.
...
"git clone https://github.com/rac-net/clab-sr.git"
